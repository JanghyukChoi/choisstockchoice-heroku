...
st.write('미국 & 한국 주식 시장에서 개인적인 관심 종목들을 선별해 공유하는 공간입니다. 제가 추천하는 종목들은 한 달간의 목표 수익률을 설정하고 있으며, 만약 한 달 이내에 이 목표를 달성하면 수익을 실현합니다. 반대로, 한 달 내에 목표 수익률의 절반 이상 손실이 발생하면 즉시 손절매를 진행합니다. ')
